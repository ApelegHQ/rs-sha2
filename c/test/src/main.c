...
/* Forward declarations for test runners generated by the macro */
int run_sha224_short_msg_tests(void);
int run_sha224_long_msg_tests(void);

int run_sha256_short_msg_tests(void);
int run_sha256_long_msg_tests(void);

int run_sha384_short_msg_tests(void);
int run_sha384_long_msg_tests(void);
...
int main(int argc, char **argv)
{
    ...
    failures |= run_sha224_short_msg_tests();
