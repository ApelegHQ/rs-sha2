...
const skip = !sha2Esm.sha384;
const getEsmInstance = () => sha2Esm.sha384();
const getCjsInstance = () => sha2Cjs.sha384();
const getWasmEsmInstance = () => sha2WasmEsm.sha384();
const getWasmCjsInstance = () => sha2WasmCjs.sha384();
