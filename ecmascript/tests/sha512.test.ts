...
const skip = !sha2Esm.sha512;
const getEsmInstance = () => sha2Esm.sha512();
const getCjsInstance = () => sha2Cjs.sha512();
const getWasmEsmInstance = () => sha2WasmEsm.sha512();
const getWasmCjsInstance = () => sha2WasmCjs.sha512();
